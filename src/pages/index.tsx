...
export default function Home() {
  return (
    <main className="bg-timberwolf">
      ...
      <section className="w-full flex flex-col py-16 justify-center items-center bg-skobeloff gap-12">
        ...
        <div className="flex flex-col sm:flex-row text-center w-full lg:p-10 gap-10 justify-center">
          <div className="p-10 w-1/5 flex flex-col gap-2 border rounded py-24">
