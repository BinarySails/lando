                ...
                <div className="w-full flex flex-col h-fit px-24 2xl:px-64 xl:px-48 md:px-24 max-[400px]:p-10 py-32">
                    <div className="w-full flex flex-col justify-start gap-8 text-start self-start">
                        ...
                        <p className="text-xl max-[400px]:text-base min-[400px]:text-2xl">
                            ...
                            <br/><br/>
                            Puede contactarnos por correo electrónico a <a className="text-blue-600/75" href="mailto:contact@lando.homes">contact@lando.homes</a> o por correo a Lando, 1234 Main Street, Anytown, CA 12345.
                            <br/><br/>
                            Estos Términos Legales constituyen un acuerdo legalmente vinculante entre usted, ya sea personalmente o en nombre de una entidad ("usted"), y en relación con su acceso y uso de los Servicios. Usted acepta que al acceder a los Servicios, ha leído, entendido y aceptado estar vinculado por todos estos Términos Legales. SI NO ESTÁ DE ACUERDO CON TODOS ESTOS TÉRMINOS LEGALES, SE LE PROHIBE EXPRESAMENTE USAR LOS SERVICIOS Y DEBE DEJAR DE USARLOS INMEDIATAMENTE.
                            <br/><br/>
                            Se incorporan expresamente en este documento los términos y condiciones adicionales o documentos que puedan publicarse en los Servicios de vez en cuando. Nos reservamos el derecho, a nuestra sola discreción, de hacer cambios o modificaciones a estos Términos Legales en cualquier momento y por cualquier motivo. Le informaremos sobre cualquier cambio actualizando la fecha de "Última actualización" de estos Términos Legales, y renuncia a cualquier derecho a recibir un aviso específico de cada uno de estos cambios. Es su responsabilidad revisar periódicamente estos Términos Legales para mantenerse informado de las actualizaciones. Estará sujeto a, y se considerará que ha sido informado de y ha aceptado, los cambios en cualquier Términos Legales revisados por su uso continuado de los Servicios después de la fecha en que se publiquen dichos Términos Legales revisados.
                            <br/><br/>
                            Los Servicios están destinados a usuarios que tengan al menos 18 años de edad. No se permite a las personas menores de 18 años usar o registrarse en los Servicios. Le recomendamos que imprima una copia de estos Términos Legales para sus registros.
                            <br/><br/>
